...
```inline
Hey there! I am an assistant professor in computer science at UofSC and a visiting researcher at Google. My research involves contributing theoretical works in Causal AI and Statistical ML and applying them for solving problems in Computer Systems and a few interdisciplinary areas in sciences and engineering. I am, in particular, interested in the theoretical foundations of Causal AI, Representation Learning, and Transfer Learning. In addition to theory, I am excited about several directions in ML for Systems and Systems for ML. In particular, I am interested in Autonomous Systems, Robot Learning, Highly-Configurable Systems, Data Analytics Pipelines, Cloud Native Systems, Microservices, Serverless, System Performance, Neural Accelerators, and ML Security/Robustness/Generalization.
```
