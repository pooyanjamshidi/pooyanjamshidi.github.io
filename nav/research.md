...
* **Trustworthy AI:** *ML Security, Robustness, Explainability*
	- With the overall goal of building reliable and trustworthy [machine learning systems](/mls), we develop methods to explain decisions made by ML models. 
...
* **ML for Systems:** *Computer Architecture, On-device ML Systems, Autonomous & Adaptive Systems, Robotics, Highly-Configurable & Composable Systems*
	...
	- We develop methods for understanding performance behavior of highly configurable and composable systems and be able to reason and predict systems qualities (e.g., throughput, energy consumption), and enable performance trade-off both at design-time and operation.