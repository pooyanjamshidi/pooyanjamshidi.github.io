...
Many small and medium sized enterprises use a form of machine learning pipeline for their tasks (e.g., fraud detection). Due to the limited resources and desire for speed, it is important to tune the neural architectures to achieve the desired accuracy and inference speed, while demanding less computing resources. My research enables organizations to get the most out of their configurable systems (in this case machine learning pipelines and deep learning models) by providing methods to understand the performance behavior and to identify the best configuration of their systems.
