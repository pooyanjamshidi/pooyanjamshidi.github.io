...
* [Microservices Architecture Enables DevOps: Migration to a Cloud-Native Architecture](https://www.slideshare.net/pooyanjamshidi/microservices-architecture-enables-devops-migration-to-a-cloudnative-architecture), Online talk, RG DevOps Performance Working Group, 2016.
...
* [Cloud Migration Patterns: A Multi-Cloud Architectural Perspective](https://www.slideshare.net/pooyanjamshidi/cloud-migrationpatterns), Ceará State University, Fortaleza, Brazil, 2015.
...
* [Self-learning Cloud Controllers](https://www.slideshare.net/pooyanjamshidi/self-learning-cloud-controllers), Trinity College Dublin, Dublin, Ireland, 2015.
